#!/usr/bin/env python3
"""
PDF Generator using WeasyPrint with HTML/CSS
Better font handling and spacing control than ReportLab
"""
...
class DeliveryNotePDFGeneratorWeasy:
    def __init__(self, non_body_csv, body_csv, output_pdf='delivery_note_weasy.pdf'):
    ...
    def generate_html(self):
        ...
        # Extract header data
        delivery_no = str(header_info.get('QI type', ''))
...
if __name__ == "__main__":
    ...
    generator = DeliveryNotePDFGeneratorWeasy(
        ...
        body_csv='body.csv',
        output_pdf='delivery_note_weasy.pdf'
    )
